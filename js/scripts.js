...
/*
$(document).ready(function(){
  var li = $('.rd-navbar-nav>li',this).has('.rd-navbar--has-dropdown');
  $('rd-navbar-submenu-toggle',li).click(function(e){
      e.preventDefault();
      $('.rd-navbar--has-dropdown').removeClass('opened');
    $(e.target).next().addClass('opened');
  });
});
*/
/*

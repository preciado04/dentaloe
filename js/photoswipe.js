...
var initPhotoSwipeFromDOM = function (gallerySelector) {
  ...
  var parseThumbnailElements = function (el) {
    ...
    for (var i = 0; i < numNodes; i++) {
      ...
      figureEl = thumbElements[i]; // This is <figure> element.
      ...
      linkEl = figureEl.children[0]; // This is<a> element.
      ...
      if (figureEl.children.length > 1) {
        // This is <figcaption> content.
        item.title = figureEl.children[1].innerHTML;
      }

      if (linkEl.children.length > 0) {
        // This is <img> thumbnail element, retrieving thumbnail url.
  ...
  var openPhotoSwipe = function (index, galleryElement, disableAnimation, fromURL) {
    ...
    gallery.listen('imageLoadComplete', function (index, item) { // Image loaded.
      $('header.page-header').addClass('hidden');
    });
    
    gallery.listen('close', function () { // Gallery starts closing.
      $('header.page-header').removeClass('hidden');
    });
  };
